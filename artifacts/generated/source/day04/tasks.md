...
- Basis (базис) - набор, который одновременно independent и порождает нужное пространство.
...
- реши: порождает ли набор всё указанное пространство, например \(\mathbb{R}^3\) или \(\mathbb{R}^4\);
- реши: basis или нет;
...
1. "Если векторов больше, чем dimension указанного пространства, они не могут породить это пространство."
2. "Если векторов меньше, чем dimension указанного пространства, они всегда dependent."
